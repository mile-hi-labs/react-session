          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                this.setState({ user: model, token: token }, function () {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                localStorage.clear();
                _context4.next = 3;
                return this.setState({ token: null, user: {} }, function () {
                  return (0, _helpers.logger)('React Session: ', _this3.state);
                });
