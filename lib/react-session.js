...
exports.withSession = exports.SessionContext = exports.SessionProvider = undefined;
...
var _localStorage = __webpack_require__(/*! local-storage */ "./node_modules/local-storage/local-storage.js");

var _localStorage2 = _interopRequireDefault(_localStorage);

var _loadContext = __webpack_require__(/*! session/load-context */ "./src/session/load-context.jsx");
...
var SessionProvider = function (_Component) {
  ...
  function SessionProvider(props) {
    ...
    _this.state = {
      ...
      loadSession: _this.loadSession.bind(_this),
  ...
  _createClass(SessionProvider, [{
    ...
    value: function componentDidMount() {
      ...
      var userId = _localStorage2.default.get('userId');
      var token = _localStorage2.default.get('token');
    ...
    key: 'loadSession',
    value: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(store, modelName, modelId, token) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return store.queryRecord(modelName, modelId, params);

              case 4:
                model = _context.sent;

                (0, _helpers.logger)('React Session: ', this.state);
      ...
      function loadSession(_x, _x2, _x3, _x4) {
    ...
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var store, modelName, userId, token, params;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                userId = _localStorage2.default.get('userId');
                token = _localStorage2.default.get('token');
                params = this.state.params;
                _context2.next = 8;
                return this.loadSession(store, modelName, userId, token, params);
              ...
              case 11:
                ...
                (0, _helpers.logger)(_context2.t0);
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _localStorage2.default.set('userId', data.id);
                _localStorage2.default.set('token', data.token);
                params = this.state.params;
                _context3.next = 6;
                return this.loadSession(store, modelName, data.id, data.token, params);
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                localStorage.clear();
                _context4.next = 3;
                return this.setState({ userId: null, token: null, user: {} }, function () {
                  return (0, _helpers.logger)('React Session: ', _this2.state);
                });
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          null,
          function (context) {
            return _react2.default.createElement(WrappedFunction, _extends({ session: context }, _this4.props));
          }
        );
      }
    }]);
...
var loadContext = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(store, state) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 3:
            ...
            _context.next = 6;
            return store.findRecord(state.modelName, state.userId, state.params);
  ...
  return function loadContext(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
/******/ });
//# sourceMappingURL=react-session.js.map