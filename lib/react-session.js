...
var SessionProvider = function (_Component) {
  ...
  _createClass(SessionProvider, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                model = _context.sent;
                _context.next = 8;
                return this.setState({ token: token, user: model }, function () {
    ...
    key: 'authenticate',
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(modelName, data) {
        var store;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                localStorage.clear();
                _context3.next = 3;
                return this.setState({ userId: '', token: '', user: {} }, function () {
